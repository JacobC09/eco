...
import { Thermometer, Home, Clock, Leaf, RefreshCw, DollarSign, Plane, ChevronDown } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-100 space-y-7">
              ...
              {nightInputs.map((input) => (
                <div key={input.key}>
                  ...
                  <Slider value={[values[input.key]]} min={input.min} max={input.max} step={input.step} onValueChange={([v]) => setValues(prev => ({ ...prev, [input.key]: v }))} />
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-4 sticky top-8">
            <div className="bg-gradient-to-br from-[#0A2F1F] to-[#14533B] rounded-3xl p-8 text-center">
