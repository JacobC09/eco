...
const stats = [
    {
        value: "63%",
        label: "of Canadian home energy used for heating",
        source: "Natural Resources Canada",
        color: "from-orange-400 to-red-400",
    },
    {
        value: "14M+",
        label: "Canadian homes with a thermostat that can be programmed",
        source: "Statistics Canada",
        color: "from-emerald-400 to-teal-400",
    },
    {
        value: "$150–$300",
        label: "average annual savings per household with scheduled heating",
        source: "Hydro One / Enbridge estimates",
        color: "from-blue-400 to-indigo-400",
    },
    {
        value: "2°C",
        label: "overnight setback that can reduce heating use by up to 5%",
        source: "Natural Resources Canada",
        color: "from-purple-400 to-pink-400",
    },
    {
        value: "4.9 Mt",
        label: "CO₂ could be saved annually if all Canadian homes optimized heating",
        source: "Canadian Climate Institute",
        color: "from-teal-400 to-emerald-400",
    },
    {
        value: "68–72°F",
        label: "recommended sleep temperature for optimal rest and energy savings",
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {stats.map((stat, i) => (
                        <motion.div
                            ...
                            className="bg-[#FAFAF7] rounded-3xl p-8 border border-gray-100 hover:border-emerald-100 hover:shadow-md transition-all duration-300 group"
                        >
                            <div className={`text-3xl md:text-4xl font-bold bg-linear-to-r ${stat.color} bg-clip-text text-transparent mb-3`}>
                                {stat.value}
                            </div>
                            <p className="text-[#0A2F1F] font-medium leading-snug mb-3">{stat.label}</p>
